...
The right value is -> 0.75931650028842677023019260789472201907809751649492435158580509...
First 10 zeros
...
int main ()
{
  ...
  printf("WRONG! The order vanishing should be 3!\n");
  printf("Epsilon = ");
  ...
  printf("WRONG! The value should be 1.7318499001193006897919750850601528449543927292761682132874...\n");
